...
export class DB {
    ...
    constructor(credentials) {
        ...
        this.conn.query('CREATE TABLE IF NOT EXISTS `gallery` ( `id` VARCHAR(36) NOT NULL, `name` VARCHAR(256) NOT NULL, `weight` BIGINT NOT NULL, `password` VARCHAR(60) NOT NULL, `role` INT NOT NULL, PRIMARY KEY (`id`)) ENGINE = InnoDB;');
